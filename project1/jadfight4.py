...
print("Rules: if Jad SLAMS his fists on the ground, you need to pray ranged as a boulder will fall from the sky and hit you if you dont.\n If Jad readies his FISTS, you need to pray melee or he will pummel you.\n If Jad CASTS METEOR at your location, you need to pray mage or you will eat a firey meteor.\n Don't Die :)")
ready= input("Press any key to start. Good Luck.\n")
