...
while player[0] > 0 and jad[0] > 0: 
   ...
   # elif prayer.lower() == jad_type[1] and random.choice(jad_type) == jad_type[1]:    
   ...
   # elif  prayer.lower() == jad_type[2] and random.choice(jad_type) == jad_type[2]:
