...
stu= (input("Pick a student between 0 and 17 or if you know the name of a specific student you would like to call, enter their name starting with a capital letter.\n"))
